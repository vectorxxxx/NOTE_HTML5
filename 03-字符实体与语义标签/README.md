...
|                             | 标签                                                         | 作用   | 描述                                                         |
| --------------------------- | :----------------------------------------------------------- | :----- | ------------------------------------------------------------ |
| 块元素<br/>Block Element    | <mark>`<h1>`</mark><br/><mark>`<h2>`</mark><br/><mark>`<h3>`</mark><br/><mark>`<h4>`</mark><br/><mark>`<h5>`</mark><br/><mark>`<h6>`</mark> | 标题   | 一共有六级标题<br/>从`h1` ~ `h6`重要性递减，`h1`最重要，`h6`最不重要<br/>h1在网页中的重要性仅次于`title`标签<br/>一般情况下一个页面中只会有一个`h1`<br/>一般情况下标题标签只会使用到`h1` ～ `h3`，`h4` ～ `h6`很少用 |
...
![image-20210515212349676](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515233457.png)
...
![HTML5 语义元素](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515211545.png)
...
- 有序列表，使用`ol`标签来创建无序列表，使用`li`表示列表项
  ...
  ![image-20210515212835770](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515233458.png)
...
- 无序列表，使用`ul`标签来创建无序列表，使用`li`表示列表项
  ...
  ![image-20210515213301387](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515233459.png)
...
- 定义列表，使用`dl`标签来创建定义列表，使用`dt`表示定义的内容，使用`dd`来对内容进行解释说明
  ...
  ![image-20210515212936773](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515233500.png)
...
- <q>Linking to an email address</q>：链接一个email地址
...
![动画2021-5-15](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515214426.gif)
...
![动画2021-5-11](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516123942.gif)
...
![动画2021-5-10](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516124131.gif)
...
![动画2021-5-14](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515230314.gif)
...
![image-20210515233449533](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210515233451.png)
...
![image-20210516001417802](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516001419.png)
...
![image-20210516002915651](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012911.png)
...
![image-20210516004453236](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012912.png)

IE8下，出现我们自定义的提示信息

![image-20210516005054543](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012913.png)
...
![image-20210516005207428](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012914.png)
...
![image-20210516012905334](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012907.png)

IE8下，也能正常播放

![image-20210516010618514](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012915.png)

### 其他

通过`iframe`和`embed`的方式引入视频。以某艺为例，提供了视频链接的HTML代码和通用代码

![image-20210516011905816](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012916.png)

![image-20210516011837229](https://gitee.com/vectorx/ImageCloud/raw/master/html5/20210516012917.png)
